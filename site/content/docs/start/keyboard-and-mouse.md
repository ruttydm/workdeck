...
Every shortcut above is a named command you can move to different keys with a `[keybindings]` table in your user config. See the repository's keybinding documentation (the website guide is still being migrated).
