...
- [Code-document file view](https://github.com/modem-dev/hunk/tree/main/examples/extensions/code-document-file-view) demonstrates API-v24 host-owned syntax paint with complete old/new documents, semantic gutters, and full/partial references.
