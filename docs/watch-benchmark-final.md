...
```text
/Users/justin/DEV/workdeck-watch-campaigns/campaigns/
...
| Primary Windows      | `windows-arm64-workdeck-windows` | Windows ARM64 VM, native Bun 1.3.14                                                          | ARM64 OpenTUI FFI cannot initialize (`TinyCC is disabled`)                     | Correctness/probe only; TUI metrics deferred            |
...
- Canonical aggregation/archive: `/Users/justin/DEV/workdeck-watch-campaigns/campaigns/<campaign-id>` on currie.
- macOS staging: `/Users/justin/workdeck-watch-campaigns/campaigns/<campaign-id>` on aarmstrong; Bun is isolated at `/Users/justin/.workdeck-watch-tools/bun-1.3.14/bin/bun`.
- Linux staging: `/home/justin/workdeck-watch-campaigns/campaigns/<campaign-id>` on sentry-agent; existing `/home/justin/perf` was inspection-only and untouched.
