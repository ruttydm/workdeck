...
fn run() -> Result<()> {
    ...
    match args.next().as_deref() {
        ...
        Some("install-vm") => install_vm::run(&repo_root()?, args),
        ...
        Some("social-cards-check") => social_cards::run_check(&repo_root()?, args),
...
fn verify() -> Result<()> {
    ...
    site_assets::verify_home_page(&repo)?;
    ...
    install_vm::verify(&repo, &resolve_commit(&repo, DEFAULT_BASELINE)?)?;
...
fn audit(options: Options, strict: bool) -> Result<()> {
    ...
    install_vm::verify(&repo, &baseline)?;
...
fn print_help() {
    ...
    println!("cargo xtask social-cards-check <staging-directory> <cards.json> [slug ...]");
    println!(
    ...
    println!("cargo xtask install-vm [--list] [--scenario ID] [--output DIR]");
    ...
    println!("cargo xtask changelog resolved-summaries <markdown-file> <dates.json> [notes.json]");
    println!("cargo xtask changelog publication <markdown-file> <dates.json>");
    ...
    println!("cargo xtask changelog feed <markdown-file> <dates.json> [notes.json]");
    println!("cargo xtask changelog index <markdown-file> <dates.json> [notes.json]");
    ...
    println!("cargo xtask changelog apply-plan <saved-plan.json> <new-backup-directory>");
    println!(
